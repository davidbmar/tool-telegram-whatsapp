# Claude Instructions — tool-telegram-whatsapp
...
PROJECT_ROOT=/Users/davidmar/src/tool-telegram-whatsapp OUTPUT_DIR=<framework>/dist/projects/tool-telegram-whatsapp/data ./scripts/build-sprint-data.sh
```
